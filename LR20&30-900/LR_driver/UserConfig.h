...
#define LORA_DEFAULT_BANDWIDTH_HZ                     500000UL
#define LORA_DEFAULT_SPREADING_FACTOR                 5U
#define LORA_DEFAULT_CODING_RATE                      5U
#define LORA_DEFAULT_TX_POWER_DBM                     22
#define LORA_DEFAULT_PREAMBLE_LENGTH                  8U
#define LORA_DEFAULT_CRC_ENABLED                      true
...
extern bool LoraSetConfig(const LoRaConfig_t *config);
extern bool LoraTxBusy(void);

extern void gpio_init(void);

extern bool LoraDataSend(const uint8_t *data, uint8_t len);
extern void DX_Lora_RadioIrqProcess(void);
extern void Modem_OnRadioTxDone(bool success);
extern void Modem_OnRadioRx(const uint8_t *payload, uint8_t length, int16_t rssi, int8_t snr);
